        ...
        <div className="mainbody">
            <div className="leftside">
                ...
                <div className="list-item">
                    ...
                    <div className="number"><span mark="true">1</span></div>
                </div>
                <div className="list-item">
                    <div className="icon"><i className="fa fa-bell"></i></div>
                    <div className="text">Employment Details</div>
                    <div className="number"><span mark="false">2</span></div>
                </div>
                <div className="list-item">
                    <div className="icon"><i className="fa fa-bell"></i></div>
            ...
            <div className="rightside">
                ...
                <p className="po">Payment Option</p>
                <div className="do">
                ...
                <div className="question">
                    <p className="quest">Whats your accomodation status?</p>
                ...
                <div className="fin">
                    <p></p>
                    <button type="button" onClick={() => nextPage()} className="finn">Next</button>
                </div>
            </div>
        </div >
    );
